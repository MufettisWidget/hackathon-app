...
class AccountApiServices {
  static Future<http.Response> createUser(User user) async {
    Map<String, String> headers = {
      ...
      'Authorization': 'Bearer  ' + SharedManager().tokenNotUser
    };

    final response = await http.post(baseUrl + 'user/CreateUser',
        headers: headers, body: postToJsonUser(user));
    return response;
  }
...
//Kullanıcın sisteme giriş yapabilmesi için çalışan api servisi
  ...
  static Future<http.Response> changePassword(
    ...
    Map<String, String> headers = {
      'Content-Type': 'application/json',
      'Authorization': 'Bearer  ' + SharedManager().jwtToken
    };
    final response = await http.get(
  ...
  static Future<http.Response> changeMailAddress(
      String userId, String password, String newEmail) async {
    Map<String, String> headers = {
      'Content-Type': 'application/json',
      'Authorization': 'Bearer  ' + SharedManager().jwtToken
    };
  ...
  static Future<http.Response> updateUser(User userIn) async {
    ...
    final response = await http.put(baseUrl + 'user',
        headers: headers, body: postToJsonUser(userIn));
    return response;
  }
  ...
  static Future<http.Response> successUser(String id) async {
    ...
    final response = await http.put(baseUrl + 'User/UpdateUserSuccess/' + id,
        headers: headers);
    return response;
  }

  static Future<http.Response> renewPassword(
